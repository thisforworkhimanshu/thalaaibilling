...
<body onload="check()">
	<%-- <%out.print(request.getSession().getAttribute("prodname")); %> --%>
<div id="container">
		<div id="FirstDiv">
	...
	<%-- 	 <div style="margin-top: 20px;">
			...
			<form action="updateProduct" method="get" style="margin-top: 50px;" name="myProductForm" onsubmit="return checkval()">
				<table border="2" height="400">
						...
						<tr>
							...
							<td><input type="text" name="pname" value="<%=session.getAttribute("prodname") %>" style="height: 30px; font-size: 20px;"></td>
						</tr>
						<tr>
							<th style="font-size: 20px;">Enter Product Price</th>
							<td><input type="text" name="pprice" value="<%=session.getAttribute("pprice") %>" style="height: 30px; font-size: 20px;"></td>
						</tr>
						<tr>
